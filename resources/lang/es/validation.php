...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'id_paymentMethod' => 'ID método de pago',
        'id_transactionConcept' => 'ID concepto de transacción',
        'id_businessDocument' => 'ID documento comercial',
        'id_currency' => 'ID moneda',
        'governmentId' => 'Número de documento',
        'amount' => 'Monto',
