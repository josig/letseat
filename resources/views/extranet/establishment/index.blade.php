                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            <button type="button" class="btn btn-light-primary font-weight-bolder dropdown-toggle"
                                ...
                                <span class="svg-icon svg-icon-md">
                                    <!--begin::Svg Icon | path:/metronic/theme/html/demo5/dist/assets/media/svg/icons/Design/PenAndRuller.svg-->
                            ...
                            @foreach ($establishments as $item)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        @can('users.edit')
                                        <a href="{{ route('users.edit', ['user' => $item->id]) }}" class="btn btn-sm btn-light btn-text-primary btn-icon mr-2" title="Editar item">
                                            <span class="menu-icon"><i class="fa fa-edit text-primary"></i></span>
                                        </a>
                                        @endcan
                                        @can('users.destroy')
                                        <a href="javascript:;" class="btn btn-sm btn-light btn-text-primary btn-icon" title="Eliminar item">
                                            <span class="menu-icon"><i class="fa fa-trash text-primary"></i></span>
                                        </a>
                                        @endcan
                                        </span>
                                    </td>
...
@section('scripts')
<script src="{{ asset('assets/js/pages/crud/ktdatatable/base/html-table.js?v=7.2.9') }}"></script>
@endsection
