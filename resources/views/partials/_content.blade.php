...
<!--begin::Entry-->
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/dashboards/demo5","page":"index"}]/-->
								...
								<div class="row">
									<div class="col-xl-8">
										...
										<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/nav-panels/widget-1","page":"index"}]/-->
										...
										<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/nav-panels/widget-1","page":"index"}]/-->
									</div>
									<div class="col-xl-4">

										<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/engage/widget-8","page":"index"}]/-->
												...
												<div class="d-flex align-items-start justify-content-start flex-grow-1 bg-light-warning p-8 card-rounded flex-grow-1 position-relative">
													<div class="d-flex flex-column align-items-start flex-grow-1 h-100">
														<div class="p-1 flex-grow-1">
															<h4 class="text-warning font-weight-bolder">Producción diaria</h4>
															<p class="text-dark-50 font-weight-bold mt-3">Generar listado de menúes</p>
														</div>
														<a href='#' class="btn btn-link btn-link-warning font-weight-bold">Crear Reporte
										...
										<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/engage/widget-8","page":"index"}]/-->
									</div>
								</div>
										...
										<div class="card card-custom bg-gray-100 gutter-b card-stretch card-shadowless">
											...
											<div class="card-header h-auto border-0">
												...
												<div class="card-title py-5">
													<h3 class="card-label">
														<span class="d-block text-dark font-weight-bolder">Ordenes recientes</span>
														<span class="d-block text-dark-50 mt-2 font-size-sm">Mas the 500+ nuevas ordenes</span>
													</h3>
												</div>
													...
													<ul class="nav nav-pills nav-pills-sm nav-dark-75" role="tablist">
														...
														<li class="nav-item">
															<a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_charts_widget_2_chart_tab_3">
																<span class="nav-text font-size-sm">Día</span>
															</a>
														</li>
													</ul>
												</div>
									...
									<div class="col-xl-4">
										...
										<div class="card card-custom bg-light-success gutter-b card-stretch card-shadowless">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-success">Usuarios</h3>
												<div class="card-toolbar">
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex align-items-center mb-10">
													...
													<div class="d-flex flex-column font-weight-bold">
														<a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">{{ $user->fullName }}</a>
														<span class="text-muted">@foreach ($user->roles as $role)
														{{ $role->description }}
														@endforeach </span>
													</div>
								...
								<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/dashboards/demo5","page":"index"}]/-->

								<!--[html-partial:end:{"id":"demo5/dist/inc/view/demos/pages/index","page":"index"}]/-->
							</div>
