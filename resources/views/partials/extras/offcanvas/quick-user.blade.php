		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="{{ route('logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Cerrar sesión</a>
						</div>
					</div>
				</div>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<!--begin::Item-->
					<a href="route('user.Auth::user->id.edit')" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">Configuración de la cuenta
