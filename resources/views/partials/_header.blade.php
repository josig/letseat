...
<div id="kt_header" class="header header-fixed">
    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-none d-lg-flex align-items-center mr-3">
            ...
            <!--begin::Logo-->
            <a href="{{ route('index') }}">
                <img alt="Logo" src="{{ asset('assets/media/logos/logo_letseat.png') }}" class="logo-sticky max-h-60px" />
            </a>
            <!--end::Logo-->
            {{--
        ...
        <div class="topbar">
            ...
            <div class="dropdown d-flex d-lg-none">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    ...
                    @include('partials.extras.dropdown.search-dropdown')
                </div>
            ...
            <!-- Button trigger modal-->
            <div class="topbar-item mr-4" data-toggle="modal" data-target="#transactionModal" data-offset="10px,0px">
                <div class="btn font-weight-bolder btn-sm btn-light-success px-5">
					...
					<span class="menu-text">Generar Transacción</span>
                </div>
            </div>
            {{--<div class="dropdown">
